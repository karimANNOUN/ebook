...
export const Testmonials = () => {
  return (
    <section className="my-8">
        <h1 className="text-2xl font-bold text-center tracking-normal underline underline-offset-8 dark:text-white mt-10">Student About CodeBook</h1>
        
<div className="grid mt-8 mx-20 border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2">
