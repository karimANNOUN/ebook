...
<div className=" h-full w-full  max-w-sm m-3 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
    <Link to={`/products/${product.id}`}>
        <img className=" p-8 h-[60%] w-full rounded-t-lg" src={product.Poster} alt="productimage" />
    </Link>
